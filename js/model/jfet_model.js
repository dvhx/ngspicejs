...
JfetModel.prototype.validate = function () {
    ...
    device_attr_check(this, this.attr, {
        ...
        cds: {type: "number", min: 0, max: 1, eng: true, equation: true},
        ...
        delta: {type: "number", min: 0, max: 50, eng: true, equation: true},
        ...
        mvst: {type: "number", min: 0, max: 100, eng: true, equation: true},
        n: {type: "number", min: 0, max: 100, eng: true, equation: true},
        p: {type: "number", min: 0, max: 30, eng: true, equation: true},
        q: {type: "number", min: 0, max: 30, eng: true, equation: true},
        taud: {type: "number", min: 0, max: 10, eng: true, equation: true},
        taug: {type: "number", min: 0, max: 10, eng: true, equation: true},
        vbd: {type: "number", min: 0, max: 100, eng: true, equation: true},
        vbi: {type: "number", min: 0, max: 100, eng: true, equation: true},
        vst: {type: "number", min: 0, max: 100, eng: true, equation: true},
        xc: {type: "number", min: 0, max: 10, eng: true, equation: true},
        xi: {type: "number", min: 0, max: 100000, eng: true, equation: true},
        z: {type: "number", min: 0, max: 100, eng: true, equation: true},
        mxi: {type: "number", min: 0, max: 3000, eng: true, equation: true},
